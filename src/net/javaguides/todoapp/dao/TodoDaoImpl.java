...
public class TodoDaoImpl implements TodoDao {
	...
	private static final String UPDATE_TODO = "update todos set title = ?, description =?, target_date =?, is_done = ? where id = ?;";
	...
	@Override
	public List<Todo> selectAllTodos(String s) {
		...
		try (Connection connection = JDBCUtils.getConnection();
			...
			while (rs.next()) {
				...
				if(isDone.equals("true")) {
					...
					todos.add(new Todo(id, title, username, description, targetDate, "Complete"));
				}
				else {
					System.out.println(isDone);
					todos.add(new Todo(id, title, username, description, targetDate, "In Progress"));
				}
